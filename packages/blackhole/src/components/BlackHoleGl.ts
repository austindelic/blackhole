import BLACK_HOLE_HELPERS from "../embedded/shaders_helpers.glsl";
import FRAGMENT_HEADER from "../embedded/shaders_fragment-header.glsl";
import asciiAnalysisSource from "../embedded/shaders_ascii-analysis.glsl";
