...
The source installer also includes @webgpu/types 0.1.74 declarations under the BSD-3-Clause license; see src/types/WebGPU-LICENSE. These declarations are development-only and are not executed in the browser.
