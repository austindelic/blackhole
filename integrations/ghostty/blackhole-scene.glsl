...
float bhOne(){return min(iResolution.x,1.0); }
#define uCameraPosition (vec3(8.6130000000,3.1586000000,21.2290000000)*bhOne())
#define uCameraRight (vec3(0.8566700691,0.4283350345,-0.2874812881)*bhOne())
#define uCameraUp (vec3(-0.4363296899,0.8989347799,0.0391492418)*bhOne())
...
vec3 stars(vec3 p) {
    vec3 col = vec3(0); float rad = .087*float(bhSourceSize().y); float dens = 0.30; float id = 0.; float z = 1.;
    for (float i = 0.; i < 5.; i++) {
...
void bhCanonicalTrace( out vec4 FragColor, in vec2 FragCoord )
{
    vec2 Resolution = vec2(bhSourceSize());
